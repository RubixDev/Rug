...
public class RedstoneLampBlockMixin {
    ...
    @Inject(method = "neighborUpdate", at = @At(value = "INVOKE", target = "Lnet/minecraft/world/World;getBlockTickScheduler()Lnet/minecraft/world/TickScheduler;"), cancellable = true)
